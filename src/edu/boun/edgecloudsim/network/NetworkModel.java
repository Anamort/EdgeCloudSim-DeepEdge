...
public abstract class NetworkModel {
    ...
    */
    ...
    public abstract double getDownloadDelayForTraining(int cloudDatacenterId, int mobileDeviceId, Task task);

	public abstract double getUploadDelayForTraining(int mobileDeviceId, int cloudDatacenterId, Task task);

	public abstract double getWanBandwidthForNextState(int sourceDeviceId, int destDeviceId, Task task);
}
